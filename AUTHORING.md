...
- No `print` outside `demo.py` / `if __name__ == "__main__":` blocks. No mutable default arguments. No module-level mutable state. Modules ≤400 lines; split when larger.
